...
редкость, регионы и таблицы наград редактируются в `plugins/VenturaFishing/treasures.yml`.
Неоткрытые сундуки можно продать вместе с рыбой через `/fish sell` или `/fsell`.
